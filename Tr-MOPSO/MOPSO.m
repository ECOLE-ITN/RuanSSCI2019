function Pareto = MOPSO(CostFunction, VarMin, VarMax, VarSize,nPop, MaxIt,TruePOF,T,FILEPATH,init_population )
     %% MOPSO Parameters
    ...
    %get POF
    for i =1:length(rep)
       Pareto.POF(i,:)=rep(i).Cost;
       Pareto.POS(i,:)=rep(i).Position;
    end
end